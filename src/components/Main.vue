<template>
  <main>
    <!-- Food is our common ground section -->
        ...
        <div class="row mx-5 px-5">
          <div class="col-4 d-flex align-items-center flex-column px-5 my-3">
            ...
            <div class="paragraph-text text-center">
              ...
              quae velit blanditiis reprehenderit.
            </div>
            <div class="py-4">
              <button class="text-small">EXPLORE THE MENU</button>
            </div>
          </div>
          <div class="col-4 d-flex align-items-center flex-column px-5 my-3">
            <div>
            ...
            <div class="py-4">
              <button class="text-small">MAKE A RESERVATION</button>
            </div>
          </div>
          <div class="col-4 d-flex align-items-center flex-column px-5 my-3">
            <div>
            ...
            <div class="py-4">
              <button class="text-small">LEARN MORE ABOUT US</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- THE BEST TABLE IN TOWN - JUMBOTRON -->
    <section id="jumbotron-1">
      <div class="container-fluid">
        <div class="row">
          <div class="col-7 p-0">
            <div id="first-jumbotron"></div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row mb-5 pb-3">
          ...
          <div class="col-4 d-flex flex-column align-items-center">
            <img
              src="../assets/imgs/blog92x-400x458.jpg"
              class="mb-4"
              alt="Coffee"
            />
          ...
          <div class="col-4 d-flex flex-column align-items-center">
            <img
              src="../assets/imgs/blog72x-400x458.jpg"
              class="mb-4"
              alt="Coffee"
            />
            <div class="h4 font-bebas">THE BEST COFFEE IN TOWN</div>
          ...
          <div class="col-4 d-flex flex-column align-items-center">
            <img
              src="../assets/imgs/blog82x-400x458.jpg"
              class="mb-4"
              alt="Coffee"
            />
            <div class="h4 font-bebas">THE BEST COFFEE IN TOWN</div>
    ...
    <section id="menus">
      <div class="big-container">
        <div class="row my-5 py-5">
          <!-- Left -->
          <div class="col-4 bg-light-gray p-5 mt-5 mb-3">
            <div class="h2 font-bebas fw-bold">HORS D'OEUVRES</div>
            <div class="menu py-3">
              <div class="d-flex justify-content-between">
                <span class="h4 font-bebas">AHI SALMON NIGIRI</span>
                <span class="cost text-small">$48</span>
              </div>
            ...
            <div class="menu py-3">
              <div class="d-flex justify-content-between">
                <span class="h4 font-bebas">AHI SALMON NIGIRI</span>
                <span class="cost text-small">$21</span>
              </div>
              <p class="paragraph-text">
                Mollis ornare sit sapien, sodales. Cursur duis proin semper
                quisque.
              </p>
            </div>
            <div class="menu py-3">
              <div class="d-flex justify-content-between">
                <span class="h4 font-bebas">AHI SALMON NIGIRI</span>
                <span class="cost text-small">$32</span>
              </div>
              <p class="paragraph-text">
                Ac vel, risus ornare senectus placerat duis amet dictumst
                tellus.
              </p>
            </div>
            <div class="menu py-3">
              <div class="d-flex justify-content-between">
                <span class="h4 font-bebas">AHI SALMON NIGIRI</span>
                <span class="cost text-small">$22</span>
              </div>
              <p class="paragraph-text">
                Ac vel, risus ornare senectus placerat duis amet dictumst
                tellus.
          ...
          <div
            id="center-menu"
            class="col-4 bg-light-gray p-5 mt-2 mb-5 text-white"
          >
            <div class="h2 font-bebas fw-bold">MAIN COURSE</div>
            <div class="menu py-3">
              <div class="d-flex justify-content-between">
                <span class="h4 font-bebas">BRAISED ABALONE</span>
                <span class="cost text-small">$52</span>
              </div>
              <p class="paragraph-text">
                Mollis ornare sit sapien, sodales. Cursur duis proin semper
                quisque.
            ...
            <div class="menu py-3">
              <div class="d-flex justify-content-between">
                <span class="h4 font-bebas">TWICE COOKED PORK</span>
                <span class="cost text-small">$21</span>
              </div>
              <p class="paragraph-text">
                Ac vel, risus ornare senectus placerat duis amet dictumst
            ...
            <div class="menu py-3">
              <div class="d-flex justify-content-between">
                <span class="h4 font-bebas">KUNG PAO CHICKEN</span>
                <span class="cost text-small">$32</span>
              </div>
              <p class="paragraph-text">
                Quis duis sit dictum aliquam a velit enim.
              </p>
            </div>
            <div class="menu py-3">
              <div class="d-flex justify-content-between">
                <span class="h4 font-bebas">CHAR SIU & SUSHIS</span>
                <span class="cost text-small">$48</span>
              </div>
              <p class="paragraph-text">
          ...
          <!-- Right -->
          <div class="col-4 bg-light-gray p-5 mt-5 mb-3">
            <div class="h2 font-bebas fw-bold">DESSERTS</div>
            <div class="menu py-3">
              <div class="d-flex justify-content-between">
                <span class="h4 font-bebas">CHOCOLATE BALL CAKE</span>
                <span class="cost text-small">$13</span>
              </div>
              <p class="paragraph-text">
            ...
            <div class="menu py-3">
              <div class="d-flex justify-content-between">
                <span class="h4 font-bebas">LIME PIE WITH CRUST</span>
                <span class="cost text-small">$14</span>
              </div>
              <p class="paragraph-text">
                Mollis ornare sit sapien, sodales. Cursur duis proin semper
                quisque.
            ...
            <div class="menu py-3">
              <div class="d-flex justify-content-between">
                <span class="h4 font-bebas">RASBERRY PEAR CAKE</span>
                <span class="cost text-small">$18</span>
              </div>
              <p class="paragraph-text">
                Eget vulputate vitae quis rutrum blandit sed. Quam nulla sit
                lacinia.
            ...
            <div class="menu py-3">
              <div class="d-flex justify-content-between">
                <span class="h4 font-bebas">CAFE AU LAIT</span>
                <span class="cost text-small">$6</span>
              </div>
              <p class="paragraph-text">
                Eget vulputate vitae quis rutrum blandit sed. Quam nulla sit
                lacinia.
...
#first-jumbotron {
  background-image: url("../assets/imgs/slider32x.jpg");
...
#takeout-jumbotron {
  background-image: url("../assets/imgs/slider72x-scaled.jpg");
  background-size: cover;
  background-repeat: no-repeat;
...
#center-menu {
  background-image: url("../assets/imgs/misc22x.jpg");
  background-size: cover;
  background-repeat: no-repeat;
  background-position: bottom center;
  filter: grayscale(70%);
